...
class AccountMove(models.Model):
    ...
    def action_custom_third_level_approval(self):
        """Action for third level approval"""
        state_list = {
            'entry': 'Journal Entry',
        ...
        for rec in self:
            ...
            if rec.custom_approval_type == 'both':
                ...
                url = base_url + '/web?login/#id=' + str(rec.id) + '&view_type=form&model=account.move'
                rec.write({
                    'custom_url': url,
